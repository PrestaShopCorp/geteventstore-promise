...
var debug = (0, _debug["default"])('geteventstore:removeProjection');
var baseErr = 'Remove Projection - ';

var _default = function _default(config) {
  return /*#__PURE__*/function () {
    var _ref = (0, _asyncToGenerator2["default"])( /*#__PURE__*/_regenerator["default"].mark(function _callee(name, deleteCheckpointStream, deleteStateStream) {
        ...
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              ...
              options = {
                url: "".concat(config.baseUrl, "/projection/").concat(name),
                method: 'DELETE',
                params: {
